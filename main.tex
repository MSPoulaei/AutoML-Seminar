...
\include{chapters/chapter2}  % فصل دوم: تعاریف و مفاهیم مبنایی 
\include{chapters/chapter3}  % فصل سوم: مروری برا کارهای مرتبط 
\include{chapters/chapter4}  % فصل سوم: نتیجه گیری و کارهای آینده
% \include{latexIntro}
...
%\baselineskip=.75cm
\onehalfspacing
\include{dic/dicfa2en}
% \include{dic/dicen2fa}
\printindex
\input{titles/enTitle}
\label{LastPage}
