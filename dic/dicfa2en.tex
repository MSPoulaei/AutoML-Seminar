...
\persiangloss{امتیازدهی ربط}{relevance scoring}
\persiangloss{امتیازدهی ربط}{relevance scoring}
...
\persiangloss{اندازه دسته}{batch sizes}
...
\persiangloss{تجربه‌های تاریخی استانداردسازی‌شده}{canonicalized historical experiences}
\persiangloss{تجربیات گذشته}{past experiences}
\persiangloss{تجزیه تخصصی}{specialized parsing}
...
\persiangloss{حافظه رویدادی}{episodic memory}
...
\persiangloss{خطوط لوله}{ML pipelines}
\persiangloss{خلاصه‌سازی متن}{text summarization}
\persiangloss{خلاصه‌های فشرده}{compressed summaries}
\persiangloss{خلاصه‌های فشرده تاریخی}{compressed historical summaries}
...
\persiangloss{فهرست‌های ساخت‌یافته فراپارامتر}{structured lists for hyperparameters}
...
\persiangloss{متن قالب‌بندی‌شده لاگ آموزشی پیش‌بینی‌شده}{formatted text for predicted training logs}
...
\persiangloss{پرومپت‌دهی تکرارشونده}{iterative prompting}
...
\persiangloss{کدگذاری کارت‌های داده}{data card encodings}
